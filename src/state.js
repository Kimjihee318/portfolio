  ...
  state: {
    showOption: {
      ...
      colors: [
        ...
        {color: '#fffae6', font:'#000', github: '#f46b9fdd', heart: '💝', emptyHeart:'#f46b9f'}, 
        {color: '#3f494f', font:'#ddd', github: '#fdda57cc', heart: '💛', emptyHeart:'#fdda57'},
        {color: '#461324', font:'#ddd', github: '#f46b9fee', heart: '💝', emptyHeart:'#f46b9f'}
      ],
